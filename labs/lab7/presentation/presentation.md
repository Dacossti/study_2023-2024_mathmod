...
3. $\frac{dn}{dt} = (0.51 + 0.31 (t)n(t))(N-n(t))$
...
prob3 = ODEProblem(f, n0, tspan2, p3)
...
Во втором случае скорость распространения рекламы будет иметь максимальное значение 962.8 в момент времени 0.156256.
